...
struct ValidationResult
{
    ...
    std::optional<double> accepted_value{};
...
public:
    ...
    [[nodiscard]] const MeasurementValidatorConfig& config() const noexcept;
    [[nodiscard]] std::optional<double> previous_valid_value() const noexcept;
    [[nodiscard]] std::optional<double> previous_valid_time() const noexcept;
...
[[nodiscard]] std::string_view to_string(MeasurementStatus status) noexcept;
